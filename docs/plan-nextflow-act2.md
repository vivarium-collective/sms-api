...
**Status (2026-09-09 01:45Z): GATES 4 AND 1b ARE CLOSED; THE NEXTFLOW RUN 2 IS RUNNING.**
...
viva-api#525 **merged** (`bd034ac9`), **live on `smsvpctest` as 0.9.128** (#527, verified on the pod 01:32Z). Simulator **178** (sms-ecoli `b7e6527`) is built — the first image that can score 11/11. Run 3 is blocked on bigraph-schema#187 (eagmon's `jump` fix) — simulator 178 predates it; a 179 is one re-pin away once it merges. Still open: Phase 3 (#449), Phase 4 (ordinal identity), PBG#208, nested
