...
**Status (2026-09-09 12:25Z): 683's gather is being flushed as sim 741 (a resume of its own campaign at 64 GB, one module at a time); the gather fixes are in review (v2ecoli#751 runner knobs, #752 one gather per variant); the Batch 30 GB root is a `cdk deploy smsvpctest-batch` away (fix already on sms-cdk main). Owner map: 683's analysis and Run 1 cell-only are mine.** Act 2 closed gates 4 and 1b and
