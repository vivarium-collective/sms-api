...
**Status (2026-09-09 08:05Z): blocker 8 fixed (v2ecoli#750) and shipped as simulator 182 (sms-ecoli `30b604b`); both pilots re-fired on it — sim 739 (Run 4, genotypes 1–3 on the rebuilt caches) and sim 740 (Run 1 cell-only, founders seed0/1). 683 on its last two lineages (retries).** Act 2 closed gates 4 and 1b and
