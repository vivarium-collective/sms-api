...
**Status (2026-09-09 05:30Z): PHASE 1 (Run 4) pilot re-fired as sim 737 on Alex's rebuilt caches (`6299ba5/`, image 181); PHASE 3 (Run 1 cell-only) pilot 734 running on 173; 683 (Run 2, 10 × 8) on its last three lineages.** Act 2 closed gates 4 and 1b and
