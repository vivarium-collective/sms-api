...
def get_experiment_dirpath(simulation_database_id: int, git_commit_hash: str, namespace: Namespaces | None = None) -> Path:
    """
...
def get_remote_chunks_dirpath(simulation_database_id: int, git_commit_hash: str, namespace: Namespaces | None = None) -> Path:
    """
    ...
    :param namespace: (`Namespaces`) Namespace used to store the results in HPC. Choose one of: prod, test, dev. Defaults to `test`.
    """
    remote_dir_root = get_experiment_dirpath(simulation_database_id=simulation_database_id, git_commit_hash=git_commit_hash, namespace=namespace)
