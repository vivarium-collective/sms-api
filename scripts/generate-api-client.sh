...
SPEC_DIR="${ROOT_DIR}/sms_api/api/specs"
LIB_DIR="${ROOT_DIR}"
...
openapi-generator generate -i "${SPEC_DIR}/openapi_3_1_0_generated.yaml" -g python -o "${LIB_DIR}" --additional-properties=packageName=${PACKAGE},generateSourceCodeOnly=true
