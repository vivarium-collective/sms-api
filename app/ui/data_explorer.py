...
@app.cell
def _():
    from config import get_settings, Settings, HPCFilePath
...
@app.cell
def _():
    # def load_sim_data(sim_data_path: str):
    #     return LoadSimData(sim_data_path).sim_data
    #
    # def load_validation_data(validation_data_path: str):
    ...
    # kb_dir = os.path.join(
    #     wd_root, "parameters", "registry", "default"
    # )
    # sim_data_path = os.path.join(
    #     kb_dir, "simData.cPickle"
    # )
    # validation_data_path = os.path.join(
    #     kb_dir, "validationData.cPickle"
    # )
...
@app.cell
def _(get_common_names, sim_data, val_label_type):
...
def _(agent_select, exp_select, gen_select, seed_select, variant_select):
    ...
    return partition_groups, partitions_display
