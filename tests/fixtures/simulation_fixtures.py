...
async def simulation_service_remote(
    slurm_service_remote: SlurmServiceRemoteHPC,
) -> AsyncGenerator[SimulationServiceRemoteHpc, None]:
    simulation_service = SimulationServiceRemoteHpc(slurm_service=slurm_service_remote)
