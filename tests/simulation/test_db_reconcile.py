...
def test_managed_database_takes_upgrade_path() -> None:
    diag = classify(
        ...
        fingerprint=[True, True, False, False, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_managed_takes_precedence_even_with_odd_fingerprint() -> None:
    diag = classify(
        ...
        fingerprint=[False, False, False, False, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.MANAGED
...
def test_legacy_matches_baseline_only() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, False, False, False, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_legacy_matches_cancelled_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, False, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_tags_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_legacy_matches_analysis_revision() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, True, True, True, True, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
    assert diag.state is DbState.LEGACY
...
def test_inconsistent_when_later_marker_present_but_earlier_missing() -> None:
    diag = classify(
        alembic_revision=None,
        fingerprint=[True, False, True, False, False, False, False, False, False, False, False, False, False, False, False],
        head_revision=HEAD,
    )
...
def test_markers_are_reported_with_labels() -> None:
    ...
    assert presence == [True, True, False, False, False, False, False, False, False, False, False, False, False, False, False]
