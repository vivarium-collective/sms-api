...
from data_model.api import WCMSimulationRequest
        ...
        try:
            ...
            for mol in result_i["bulk"]:
                ...
                bulk_mol = {
                    ...
                    "count": mol_count,
                    "submasses": mol,
                }  # BulkMoleculeData(id=mol_id, count=mol_count, submasses=mol)
            ...
            listener_results_i = dict(
                zip(extracted_listeners, list(map(lambda name: listener_data[name], extracted_listeners)))
            )
            ...
            response_i = {
                ...
                "data": {"bulk": bulk_results_i, "listeners": listener_results_i},
            }
