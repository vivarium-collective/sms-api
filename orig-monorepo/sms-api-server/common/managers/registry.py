...
class RegistryManager:
    ...
    def get(self, registry_id: str) -> ProcessTypes:
        ...
        if exists:
            ...
            raise RuntimeError(
                f"Registry with ID: {registry_id} has not yet been registered. Use this class' add_registry method first."
            )
    ...
    def set(self, reg_id: str, new: ProcessTypes):
        ...
        if exists:
            ...
            raise RuntimeError(
                "This registry has not yet been registered. Use this class' add_registry method instead."
            )
    ...
    def add(self, registry_id: str, reg: ProcessTypes):
        ...
        if not exists:
            ...
            raise RuntimeError(
                "This registry has already been registered. Use this class' set_registry method instead."
            )
