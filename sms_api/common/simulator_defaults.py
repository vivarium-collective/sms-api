...
class SimulationConfigPublic(StrEnumBase):
    ...
    VIO_NO_MET = ""
    MEC = ""
    # Sensitivity campaign configs (multi-parca + perturbed RNA-seq datasets).
    # Generated by `vEcoli/runscripts/run_sensitivity_campaign.py`; see
    # `.claude/plans/dataset-sensitivity-exploration.md` Part 4.
    PILOT_EXPRESSION_NOISE = "configs/campaigns/pilot_expression_noise.json"
...
ACCEPTED_REPOS = {
    ...
    # `multi-parca-aws` and `multi-parca-workflow` carry the multi-parca
    # sensitivity-campaign infrastructure (see plan).
    RepoUrl.VECOLI_PUBLIC_REPO_URL: [
        "master",
        "ptools_viz",
        "multi-parca-aws",
        "multi-parca-workflow",
    ],
