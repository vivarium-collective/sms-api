...
from ...models.package_registration_request import PackageRegistrationRequest
...
def _get_kwargs(
    *,
    body: PackageRegistrationRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Register a package from a repo URL, local path, or inline outline
