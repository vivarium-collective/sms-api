...
class ParcaDataset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["database_id", "parca_dataset_request", "remote_archive_path", "hpc_run"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parca_dataset_request": ParcaDatasetRequest.from_dict(obj["parca_dataset_request"])
            if obj.get("parca_dataset_request") is not None
            else None,
