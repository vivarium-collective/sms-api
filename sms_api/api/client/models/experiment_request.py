...
class ExperimentRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        simulation_name: Union[None, Unset, str]
        if isinstance(self.simulation_name, Unset):
            simulation_name = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_simulation_name(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        simulation_name = _parse_simulation_name(d.pop("simulation_name", UNSET))
        ...
        lineage_seed = d.pop("lineage_seed", UNSET)
