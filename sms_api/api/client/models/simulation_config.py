...
class SimulationConfig:
    ...
    Attributes:
        ...
        process_configs (Union[Unset, SimulationConfigProcessConfigs]):
        topology (Union[Unset, SimulationConfigTopology]):
        ...
        spatial_environment_config (Union[Unset, SimulationConfigSpatialEnvironmentConfig]):
        swap_processes (Union[Unset, SimulationConfigSwapProcesses]):
        flow (Union[Unset, SimulationConfigFlow]):
        initial_state_overrides (Union[Unset, list[str]]):
        initial_state (Union[Unset, SimulationConfigInitialState]):
    """
    ...
    process_configs: Union[Unset, "SimulationConfigProcessConfigs"] = UNSET
    topology: Union[Unset, "SimulationConfigTopology"] = UNSET
    ...
    spatial_environment_config: Union[Unset, "SimulationConfigSpatialEnvironmentConfig"] = UNSET
    swap_processes: Union[Unset, "SimulationConfigSwapProcesses"] = UNSET
    flow: Union[Unset, "SimulationConfigFlow"] = UNSET
    initial_state_overrides: Union[Unset, list[str]] = UNSET
    initial_state: Union[Unset, "SimulationConfigInitialState"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_emitter_arg, Unset):
            ...
            emitter_arg = SimulationConfigEmitterArg.from_dict(_emitter_arg)
        ...
        if isinstance(_process_configs, Unset):
            ...
            process_configs = SimulationConfigProcessConfigs.from_dict(_process_configs)
        ...
        if isinstance(_topology, Unset):
            ...
            topology = SimulationConfigTopology.from_dict(_topology)
        ...
        if isinstance(_spatial_environment_config, Unset):
            ...
            spatial_environment_config = SimulationConfigSpatialEnvironmentConfig.from_dict(_spatial_environment_config)
        ...
        if isinstance(_swap_processes, Unset):
            ...
            swap_processes = SimulationConfigSwapProcesses.from_dict(_swap_processes)
        ...
        if isinstance(_flow, Unset):
            ...
            flow = SimulationConfigFlow.from_dict(_flow)
        ...
        if isinstance(_initial_state, Unset):
            ...
            initial_state = SimulationConfigInitialState.from_dict(_initial_state)
