...
T = TypeVar("T", bound="ExperimentRequestVariantsAdditionalPropertyAdditionalProperty")


@_attrs_define
class ExperimentRequestVariantsAdditionalPropertyAdditionalProperty:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        experiment_request_variants_additional_property_additional_property = cls()
        ...
        experiment_request_variants_additional_property_additional_property.additional_properties = (
            additional_properties
        )
        return experiment_request_variants_additional_property_additional_property
