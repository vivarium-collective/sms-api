...
class EcoliSimulationRun(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job_id", "simulation", "last_update"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "simulation": EcoliSimulation.from_dict(obj["simulation"]) if obj.get("simulation") is not None else None,
