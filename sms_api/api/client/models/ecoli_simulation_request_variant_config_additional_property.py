...
T = TypeVar("T", bound="EcoliSimulationRequestVariantConfigAdditionalProperty")
...
class EcoliSimulationRequestVariantConfigAdditionalProperty:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        ecoli_simulation_request_variant_config_additional_property = cls()
        ...
        ecoli_simulation_request_variant_config_additional_property.additional_properties = additional_properties
        return ecoli_simulation_request_variant_config_additional_property
