...
class RegisteredSimulators(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["versions", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [SimulatorVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None,
