...
T = TypeVar("T", bound="ParcaDatasetRequestParcaConfigType0")


@_attrs_define
class ParcaDatasetRequestParcaConfigType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        parca_dataset_request_parca_config_type_0 = cls()
        ...
        parca_dataset_request_parca_config_type_0.additional_properties = additional_properties
        return parca_dataset_request_parca_config_type_0
