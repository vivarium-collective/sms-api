...
def make_elongation_rates_flat(size, base, amplified, ceiling, variable_elongation=False):
...
def make_elongation_rates(random, size, base, amplified, ceiling, time_step, variable_elongation=False):
