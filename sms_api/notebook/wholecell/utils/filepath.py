...
def git_hash():
    ...
    """
    return run_cmdline("git rev-parse HEAD", fallback=os.environ.get("IMAGE_GIT_HASH", "--"))
...
def iter_variants(variant_type: str, first_index: int, last_index: int) -> Generator[tuple[int, str], None, None]:
