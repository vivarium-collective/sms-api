...
class DependencyGraph(object):
    ...
    def _topo_sort_dfs(self, node: str, explored: dict[str, int], reverse_ordering: list[str]):
        ...
        for dependency in self.dependencies[node]:
            if explored[dependency] == ExplorationStatus.UNEXPLORED:
                ...
                raise InvalidDependencyGraphError("Dependency graphs must not contain cycles")
