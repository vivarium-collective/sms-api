...
class Test_FluxBalanceAnalysis(unittest.TestCase):
    ...
    def test_standard(self):
        ...
        fba.setExternalMoleculeLevels([
            externalMoleculeLevels[moleculeID] for moleculeID in fba.getExternalMoleculeIDs()
        ])
    ...
    def test_homeostatic_noInitial(self):
        ...
        fba.setInternalMoleculeLevels([
            internalMoleculeLevels[moleculeID] for moleculeID in fba.getInternalMoleculeIDs()
        ])
