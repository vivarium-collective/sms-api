...
from ...models.body_run_uploaded_task import BodyRunUploadedTask
...
def sync_detailed(
    *,
    ...
    """Upload a script and run it on the in-region task compute (viva-api#631)
