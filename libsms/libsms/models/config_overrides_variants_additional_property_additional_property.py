...
T = TypeVar("T", bound="ConfigOverridesVariantsAdditionalPropertyAdditionalProperty")


@_attrs_define
class ConfigOverridesVariantsAdditionalPropertyAdditionalProperty:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        config_overrides_variants_additional_property_additional_property = cls()
        ...
        config_overrides_variants_additional_property_additional_property.additional_properties = additional_properties
        return config_overrides_variants_additional_property_additional_property
