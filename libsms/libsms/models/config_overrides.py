...
if TYPE_CHECKING:
    from ..models.config_overrides_analysis_options import ConfigOverridesAnalysisOptions
    from ..models.config_overrides_emitter_arg import ConfigOverridesEmitterArg
    from ..models.config_overrides_flow import ConfigOverridesFlow
    from ..models.config_overrides_initial_state import ConfigOverridesInitialState
    from ..models.config_overrides_parca_options import ConfigOverridesParcaOptions
    from ..models.config_overrides_process_configs import ConfigOverridesProcessConfigs
    from ..models.config_overrides_spatial_environment_config import ConfigOverridesSpatialEnvironmentConfig
    from ..models.config_overrides_swap_processes import ConfigOverridesSwapProcesses
    from ..models.config_overrides_topology import ConfigOverridesTopology
    from ..models.config_overrides_variants import ConfigOverridesVariants


T = TypeVar("T", bound="ConfigOverrides")
...
class ConfigOverrides:
    ...
    Attributes:
        ...
        parca_options (Union[Unset, ConfigOverridesParcaOptions]):
        ...
        emitter_arg (Union[Unset, ConfigOverridesEmitterArg]):
        variants (Union[Unset, ConfigOverridesVariants]):
        analysis_options (Union[Unset, ConfigOverridesAnalysisOptions]):
        ...
        process_configs (Union[Unset, ConfigOverridesProcessConfigs]):
        topology (Union[Unset, ConfigOverridesTopology]):
        ...
        spatial_environment_config (Union[Unset, ConfigOverridesSpatialEnvironmentConfig]):
        swap_processes (Union[Unset, ConfigOverridesSwapProcesses]):
        flow (Union[Unset, ConfigOverridesFlow]):
        initial_state_overrides (Union[Unset, list[str]]):
        initial_state (Union[Unset, ConfigOverridesInitialState]):
    """

    experiment_id: Union[None, Unset, str] = UNSET
    sim_data_path: Union[None, Unset, str] = UNSET
    suffix_time: Union[Unset, bool] = False
    parca_options: Union[Unset, "ConfigOverridesParcaOptions"] = UNSET
    ...
    emitter_arg: Union[Unset, "ConfigOverridesEmitterArg"] = UNSET
    variants: Union[Unset, "ConfigOverridesVariants"] = UNSET
    analysis_options: Union[Unset, "ConfigOverridesAnalysisOptions"] = UNSET
    ...
    process_configs: Union[Unset, "ConfigOverridesProcessConfigs"] = UNSET
    topology: Union[Unset, "ConfigOverridesTopology"] = UNSET
    ...
    spatial_environment_config: Union[Unset, "ConfigOverridesSpatialEnvironmentConfig"] = UNSET
    swap_processes: Union[Unset, "ConfigOverridesSwapProcesses"] = UNSET
    flow: Union[Unset, "ConfigOverridesFlow"] = UNSET
    initial_state_overrides: Union[Unset, list[str]] = UNSET
    initial_state: Union[Unset, "ConfigOverridesInitialState"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parca_options, Unset):
            ...
            parca_options = ConfigOverridesParcaOptions.from_dict(_parca_options)
        ...
        if isinstance(_emitter_arg, Unset):
            ...
            emitter_arg = ConfigOverridesEmitterArg.from_dict(_emitter_arg)
        ...
        if isinstance(_variants, Unset):
            ...
            variants = ConfigOverridesVariants.from_dict(_variants)
        ...
        if isinstance(_analysis_options, Unset):
            ...
            analysis_options = ConfigOverridesAnalysisOptions.from_dict(_analysis_options)
        ...
        if isinstance(_process_configs, Unset):
            ...
            process_configs = ConfigOverridesProcessConfigs.from_dict(_process_configs)
        ...
        if isinstance(_topology, Unset):
            ...
            topology = ConfigOverridesTopology.from_dict(_topology)
        ...
        if isinstance(_spatial_environment_config, Unset):
            ...
            spatial_environment_config = ConfigOverridesSpatialEnvironmentConfig.from_dict(_spatial_environment_config)
        ...
        if isinstance(_swap_processes, Unset):
            ...
            swap_processes = ConfigOverridesSwapProcesses.from_dict(_swap_processes)
        ...
        if isinstance(_flow, Unset):
            ...
            flow = ConfigOverridesFlow.from_dict(_flow)
        ...
        if isinstance(_initial_state, Unset):
            ...
            initial_state = ConfigOverridesInitialState.from_dict(_initial_state)

        config_overrides = cls(
        ...
        config_overrides.additional_properties = d
