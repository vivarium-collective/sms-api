...
if TYPE_CHECKING:
    from ..models.simulation_configuration_analysis_options import SimulationConfigurationAnalysisOptions
    from ..models.simulation_configuration_emitter_arg import SimulationConfigurationEmitterArg
    from ..models.simulation_configuration_flow import SimulationConfigurationFlow
    from ..models.simulation_configuration_initial_state import SimulationConfigurationInitialState
    from ..models.simulation_configuration_parca_options import SimulationConfigurationParcaOptions
    from ..models.simulation_configuration_process_configs import SimulationConfigurationProcessConfigs
    from ..models.simulation_configuration_spatial_environment_config import (
        SimulationConfigurationSpatialEnvironmentConfig,
    )
    from ..models.simulation_configuration_swap_processes import SimulationConfigurationSwapProcesses
    from ..models.simulation_configuration_topology import SimulationConfigurationTopology
    from ..models.simulation_configuration_variants_type_0 import SimulationConfigurationVariantsType0


T = TypeVar("T", bound="SimulationConfiguration")
...
class SimulationConfiguration:
    ...
    Attributes:
        ...
        suffix_time (Union[None, Unset, bool]):
        parca_options (Union[Unset, SimulationConfigurationParcaOptions]):
        generations (Union[None, Unset, int]):
        n_init_sims (Union[None, Unset, int]):
        max_duration (Union[None, Unset, float]):
        initial_global_time (Union[None, Unset, float]):
        time_step (Union[None, Unset, float]):
        single_daughters (Union[None, Unset, bool]):
        emitter (Union[None, Unset, str]):
        emitter_arg (Union[Unset, SimulationConfigurationEmitterArg]):
        variants (Union['SimulationConfigurationVariantsType0', None, Unset]):
        analysis_options (Union[Unset, SimulationConfigurationAnalysisOptions]):
        ...
        save (Union[None, Unset, bool]):
        save_times (Union[Unset, list[str]]):
        ...
        process_configs (Union[Unset, SimulationConfigurationProcessConfigs]):
        topology (Union[Unset, SimulationConfigurationTopology]):
        engine_process_reports (Union[Unset, list[list[str]]]):
        emit_paths (Union[Unset, list[str]]):
        progress_bar (Union[None, Unset, bool]):
        ...
        raw_output (Union[None, Unset, bool]):
        ...
        daughter_outdir (Union[None, Unset, str]):
        lineage_seed (Union[None, Unset, int]):
        fail_at_max_duration (Union[None, Unset, bool]):
        inherit_from (Union[Unset, list[str]]):
        spatial_environment_config (Union[Unset, SimulationConfigurationSpatialEnvironmentConfig]):
        swap_processes (Union[Unset, SimulationConfigurationSwapProcesses]):
        flow (Union[Unset, SimulationConfigurationFlow]):
        initial_state_overrides (Union[Unset, list[str]]):
        initial_state (Union[Unset, SimulationConfigurationInitialState]):
    """

    experiment_id: Union[None, Unset, str] = UNSET
    sim_data_path: Union[None, Unset, str] = UNSET
    suffix_time: Union[None, Unset, bool] = UNSET
    parca_options: Union[Unset, "SimulationConfigurationParcaOptions"] = UNSET
    generations: Union[None, Unset, int] = UNSET
    n_init_sims: Union[None, Unset, int] = UNSET
    max_duration: Union[None, Unset, float] = UNSET
    initial_global_time: Union[None, Unset, float] = UNSET
    time_step: Union[None, Unset, float] = UNSET
    single_daughters: Union[None, Unset, bool] = UNSET
    emitter: Union[None, Unset, str] = UNSET
    emitter_arg: Union[Unset, "SimulationConfigurationEmitterArg"] = UNSET
    variants: Union["SimulationConfigurationVariantsType0", None, Unset] = UNSET
    analysis_options: Union[Unset, "SimulationConfigurationAnalysisOptions"] = UNSET
    ...
    save: Union[None, Unset, bool] = UNSET
    save_times: Union[Unset, list[str]] = UNSET
    ...
    process_configs: Union[Unset, "SimulationConfigurationProcessConfigs"] = UNSET
    topology: Union[Unset, "SimulationConfigurationTopology"] = UNSET
    engine_process_reports: Union[Unset, list[list[str]]] = UNSET
    emit_paths: Union[Unset, list[str]] = UNSET
    progress_bar: Union[None, Unset, bool] = UNSET
    ...
    raw_output: Union[None, Unset, bool] = UNSET
    ...
    daughter_outdir: Union[None, Unset, str] = UNSET
    ...
    spatial_environment_config: Union[Unset, "SimulationConfigurationSpatialEnvironmentConfig"] = UNSET
    swap_processes: Union[Unset, "SimulationConfigurationSwapProcesses"] = UNSET
    flow: Union[Unset, "SimulationConfigurationFlow"] = UNSET
    initial_state_overrides: Union[Unset, list[str]] = UNSET
    initial_state: Union[Unset, "SimulationConfigurationInitialState"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        suffix_time: Union[None, Unset, bool]
        if isinstance(self.suffix_time, Unset):
            suffix_time = UNSET
        else:
        ...
        generations: Union[None, Unset, int]
        if isinstance(self.generations, Unset):
            generations = UNSET
        else:
        ...
        initial_global_time: Union[None, Unset, float]
        if isinstance(self.initial_global_time, Unset):
            initial_global_time = UNSET
        else:
            initial_global_time = self.initial_global_time

        time_step: Union[None, Unset, float]
        if isinstance(self.time_step, Unset):
            time_step = UNSET
        else:
            time_step = self.time_step

        single_daughters: Union[None, Unset, bool]
        if isinstance(self.single_daughters, Unset):
            single_daughters = UNSET
        else:
            single_daughters = self.single_daughters

        emitter: Union[None, Unset, str]
        if isinstance(self.emitter, Unset):
            emitter = UNSET
        else:
        ...
        variants: Union[None, Unset, dict[str, Any]]
        if isinstance(self.variants, Unset):
            variants = UNSET
        elif isinstance(self.variants, SimulationConfigurationVariantsType0):
        ...
        save: Union[None, Unset, bool]
        if isinstance(self.save, Unset):
            save = UNSET
        else:
            save = self.save

        save_times: Union[Unset, list[str]] = UNSET
        if not isinstance(self.save_times, Unset):
        ...
        raw_output: Union[None, Unset, bool]
        if isinstance(self.raw_output, Unset):
            raw_output = UNSET
        else:
        ...
        daughter_outdir: Union[None, Unset, str]
        if isinstance(self.daughter_outdir, Unset):
            daughter_outdir = UNSET
        else:
        ...
        if emitter is not UNSET:
            field_dict["emitter"] = emitter
        ...
        if save_times is not UNSET:
            field_dict["save_times"] = save_times
        ...
        if daughter_outdir is not UNSET:
            field_dict["daughter_outdir"] = daughter_outdir
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sim_data_path = _parse_sim_data_path(d.pop("sim_data_path", UNSET))

        def _parse_suffix_time(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        suffix_time = _parse_suffix_time(d.pop("suffix_time", UNSET))
        ...
        if isinstance(_parca_options, Unset):
            ...
            parca_options = SimulationConfigurationParcaOptions.from_dict(_parca_options)

        def _parse_generations(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        generations = _parse_generations(d.pop("generations", UNSET))
        ...
        def _parse_max_duration(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_initial_global_time(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        initial_global_time = _parse_initial_global_time(d.pop("initial_global_time", UNSET))

        def _parse_time_step(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        time_step = _parse_time_step(d.pop("time_step", UNSET))

        def _parse_single_daughters(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        single_daughters = _parse_single_daughters(d.pop("single_daughters", UNSET))

        def _parse_emitter(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        emitter = _parse_emitter(d.pop("emitter", UNSET))
        ...
        if isinstance(_emitter_arg, Unset):
            ...
            emitter_arg = SimulationConfigurationEmitterArg.from_dict(_emitter_arg)

        def _parse_variants(data: object) -> Union["SimulationConfigurationVariantsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                variants_type_0 = SimulationConfigurationVariantsType0.from_dict(data)

                return variants_type_0
            except:  # noqa: E722
                pass
            return cast(Union["SimulationConfigurationVariantsType0", None, Unset], data)
        ...
        if isinstance(_analysis_options, Unset):
            ...
            analysis_options = SimulationConfigurationAnalysisOptions.from_dict(_analysis_options)
        ...
        def _parse_save(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        save = _parse_save(d.pop("save", UNSET))

        save_times = cast(list[str], d.pop("save_times", UNSET))
        ...
        if isinstance(_process_configs, Unset):
            ...
            process_configs = SimulationConfigurationProcessConfigs.from_dict(_process_configs)
        ...
        if isinstance(_topology, Unset):
            ...
            topology = SimulationConfigurationTopology.from_dict(_topology)
        ...
        def _parse_progress_bar(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_raw_output(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        raw_output = _parse_raw_output(d.pop("raw_output", UNSET))
        ...
        def _parse_daughter_outdir(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        daughter_outdir = _parse_daughter_outdir(d.pop("daughter_outdir", UNSET))
        ...
        if isinstance(_spatial_environment_config, Unset):
            ...
            spatial_environment_config = SimulationConfigurationSpatialEnvironmentConfig.from_dict(
        ...
        if isinstance(_swap_processes, Unset):
            ...
            swap_processes = SimulationConfigurationSwapProcesses.from_dict(_swap_processes)
        ...
        if isinstance(_flow, Unset):
            ...
            flow = SimulationConfigurationFlow.from_dict(_flow)
        ...
        if isinstance(_initial_state, Unset):
            ...
            initial_state = SimulationConfigurationInitialState.from_dict(_initial_state)

        simulation_configuration = cls(
        ...
        simulation_configuration.additional_properties = d
